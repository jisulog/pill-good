...
urlpatterns = [
    ...
    path('lec/reject/<int:pk>/', views.manager_lec_reject, name="manager_lec_reject"),
    ...
    path('refund/reject/<int:pk>/', views.manager_refund_reject, name="manager_refund_reject"),
]